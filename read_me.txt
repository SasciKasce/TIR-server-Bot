...
Триггером для обновления данных о роли пользователя, нике пользователя, а также получении информации о новых пользователях служит отправка сообщений (за исключением команд). 
